...
%----------------------
% Read the image
filename=fullfile('..','Test_images/','W8446B185_2017-12-18_03-14-57.img');
...
lats=linspace(glat-2.6,glat+2.6,Ngrid);
lons=linspace(glon-13,glon+13,Ngrid);
...
mapped_asc=reshape(interp2(img,j,i,'linear',NaN),size(theta_mesh));
mapped_asc=mapped_asc';
...
subplot(1,3,3)
i=imread('../Test_images/W8446B185_2017-12-18_03-14-57.jpg');
i=imrotate(i,rotAngle*180/pi,'crop');
imagesc(i)
axis image
title('Reference quicklook image')